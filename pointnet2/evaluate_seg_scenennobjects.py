...
parser.add_argument('--model', default='pointnet2_cls_bga', help='Model name. [default: pointnet2_cls_ssg]')
...
parser.add_argument('--model_path', default='BGA_PN2/log_PBT50RS_seg2_v2/model.ckpt', help='model checkpoint file path [default: log/model.ckpt]')
...
parser.add_argument('--visu_mask', default = True, help='Whether to dump mask [default: False]')
...
def evaluate(num_votes):
    ...
    with tf.device('/gpu:'+str(GPU_INDEX)):
        ...
        # simple model
        class_pred, seg_pred = MODEL.get_model(pointclouds_pl, is_training_pl)
